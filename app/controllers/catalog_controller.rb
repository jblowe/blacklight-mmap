...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    # FACET FIELDS
     config.add_facet_field  'site_name_s'     , label: 'Site Name'
     config.add_facet_field  'date_discovered_s'     , label: 'Date Discovered'
     config.add_facet_field  'bag_id_s'     , label: 'Bag Id'
     config.add_facet_field  'artifact_class_s'     , label: 'Artifact Class'
     config.add_facet_field  'period_s'     , label: 'Period'
     config.add_facet_field  'material_s'     , label: 'Material'
     config.add_facet_field  'bur_phase_s'     , label: 'Bur Phase'
     config.add_facet_field  'level_s'     , label: 'Level'
     config.add_facet_field  'square_s'     , label: 'Square'
     config.add_facet_field  'quad_s'     , label: 'Quad'
     config.add_facet_field  'layer_s'     , label: 'Layer'
     config.add_facet_field  'feano_s'     , label: 'Feano'
     config.add_facet_field  'featype_s'     , label: 'Featype'
     config.add_facet_field  'flag_for_check_s'     , label: 'Flag For Check'
